    ...
    <>
      <div className="p-5 border border-border rounded-2xl lg:p-6">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <h4 className="text-lg font-semibold text-foreground lg:mb-6">地址信息</h4>

            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              <div>
                <p className="mb-2 text-xs leading-normal text-muted-foreground">国家/地区</p>
              ...
              <div>
                <p className="mb-2 text-xs leading-normal text-muted-foreground">城市</p>
                <p className="text-sm font-medium text-foreground">
              ...
              <div>
                <p className="mb-2 text-xs leading-normal text-muted-foreground">邮编</p>
                <p className="text-sm font-medium text-foreground">
              ...
              <div>
                <p className="mb-2 text-xs leading-normal text-muted-foreground">税号</p>
                <p className="text-sm font-medium text-foreground">
